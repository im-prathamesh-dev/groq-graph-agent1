...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col justify-center items-center px-6 relative overflow-hidden radial-glow-blue grid-bg-overlay">
      ...
      {/* Glow balls */}
      <div className="absolute top-1/4 right-1/3 w-96 h-96 bg-blue-500/10 rounded-full blur-[100px] pointer-events-none" />
      ...
      >
        ...
        <div className="text-center mb-8 flex flex-col items-center">
          ...
          <p className="text-slate-500 dark:text-slate-400 text-sm mt-2">
            Sign in to access your AI resume grading workspace
          </p>
        </div>
